...
void UHeroGameplayAbility_TargetLock::SwitchTarget(const FGameplayTag& InSwitchDirectionTag)
{
	...
	{
		NewTargetToLock = GetNearestAvailbleTargetFromAvailableActors(ActorsOnLeft);
	}
	else
	{
		NewTargetToLock = GetNearestAvailbleTargetFromAvailableActors(ActorsOnRight);
	}
...
void UHeroGameplayAbility_TargetLock::TryLockOnTarget()
{
	...
	CurrentLockedActor = GetNearestAvailbleTargetFromAvailableActors(AvailableActorsToLock);
...
AActor* UHeroGameplayAbility_TargetLock::GetNearestAvailbleTargetFromAvailableActors(const TArray<AActor*>& InAvailableActors)
{
