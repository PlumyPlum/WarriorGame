...
void UWarriorAttributeSet::PostGameplayEffectExecute(const FGameplayEffectModCallbackData& Data)
{
	...
	UPawnUIComponent* UPawnUIComponent = CachedPawnUIInterface->GetPawnUIComponent();

	checkf(UPawnUIComponent, TEXT("Couldn't extract a {AwnUIComponent from %s"), *Data.Target.GetAvatarActor()->GetActorNameOrLabel());
	...
	{ 
		...
		UPawnUIComponent->OnCurrentHealthChanged.Broadcast(GetCurrentHealth() / GetMaxHealth());
	}
